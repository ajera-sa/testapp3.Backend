    ...
    ITransientDependency
{
    ...
    public async Task HandleEventAsync(TenantCreatedEto eventData)
    {
        await MigrateAndSeedForTenantAsync(
            eventData.Id,
            eventData.Properties.GetOrDefault("AdminEmail") ?? Consts.AdminEmailDefaultValue,
            eventData.Properties.GetOrDefault("AdminPassword") ?? Consts.AdminPasswordDefaultValue
        );
    }
    ...
    public async Task HandleEventAsync(TenantConnectionStringUpdatedEto eventData)
    {
        ...
        await MigrateAndSeedForTenantAsync(
            eventData.Id,
            Consts.AdminEmailDefaultValue,
            Consts.AdminPasswordDefaultValue
        );
